...
"""
# Quelle: https://github.com/loiseaujc/TowardsDataScience/tree/master/A%20quick%20introduction%20to%20deep%20learning%20for%20beginners
...
def H(x): return np.int_(np.heaviside(x, 1))
...
class Rosenblatt(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, y, maxiter=2000):
        ...
        if errors[-1] != 0:
            print("Verbleibende Fehler:", errors[-1])
            warnings.warn(
